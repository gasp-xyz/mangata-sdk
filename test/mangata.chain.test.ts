...
it.concurrent(
  "should retrive chain name when calling getChain method",
  async () => {
...
it.concurrent(
  "should match version 0.4.0 node version when calling getNodeVersion method",
  async () => {
...
it.concurrent("should match name when calling getNodeName method", async () => {
  const name = "Mangata";
