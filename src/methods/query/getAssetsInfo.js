...
exports.getAssetsInfo = void 0;
var util_1 = require("@polkadot/util");
var getCompleteAssetsInfo_1 = require("../../utils/getCompleteAssetsInfo");
var getAssetsInfo = function (instancePromise) { return __awaiter(void 0, void 0, void 0, function () {
    var api, completeAssetsInfo;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, instancePromise];
            case 1:
                api = _a.sent();
                return [4 /*yield*/, (0, getCompleteAssetsInfo_1.getCompleteAssetsInfo)(api)];
            case 2:
                ...
                return [2 /*return*/, Object.values(completeAssetsInfo)
                        .filter(function (assetsInfo) { return !["1", "3", "6"].includes(assetsInfo.id); })
                        ...
                        var asset = __assign(__assign({}, item), { name: item.name.replace(/0x\w+/, "").replace(/[A-Z]/g, " $&").trim(), symbol: item.symbol.includes("TKN")
                                ? item.symbol
                                    ...
                                    var tokenId = currentValue.startsWith("0x")
                                        ...
                                        : currentValue;
                                    var symbol = completeAssetsInfo[tokenId].symbol;
                                    acc.push(symbol);
                                    return acc;
                                }, [])
                                    .join("-")
...
exports.getAssetsInfo = getAssetsInfo;
