...
exports.forWithdraw = void 0;
var util_crypto_1 = require("@polkadot/util-crypto");
var util_1 = require("@polkadot/util");
var getWeightXTokens_1 = require("../../utils/getWeightXTokens");
var bnUtility_1 = require("../../utils/bnUtility");
var forWithdraw = function (instancePromise, args) { return __awaiter(void 0, void 0, void 0, function () {
    var api, tokenSymbol, withWeight, parachainId, account, destinationAddress, amount, correctAddress, assetRegistryMetadata, assetMetadata, tokenId, destination, destWeightLimit, dispatchInfo;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, instancePromise];
            case 1:
                api = _a.sent();
                tokenSymbol = args.tokenSymbol, withWeight = args.withWeight, parachainId = args.parachainId, account = args.account, destinationAddress = args.destinationAddress, amount = args.amount;
            ...
            case 2:
                ...
                return [4 /*yield*/, api.tx.xTokens
                        .transfer(tokenId, amount, destination, destWeightLimit)
                        .paymentInfo(account)];
            case 3:
                dispatchInfo = _a.sent();
                return [2 /*return*/, (0, bnUtility_1.fromBN)(new util_1.BN(dispatchInfo.partialFee.toString()))];
            case 4: return [2 /*return*/, "0"];
        }
    });
}); };
exports.forWithdraw = forWithdraw;
